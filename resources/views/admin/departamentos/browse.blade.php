                ...
                <div class="panel panel-bordered" style="margin-bottom: 0;">
                    <div class="panel-body" style="padding: 0;">
                        <div class="col-md-8" style="padding: 0;">
                            <h1 class="page-title">
                                <i class="voyager-categories"></i> Departamentos
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px;">
                            @can('create', App\Models\Departamento::class)
                                <a href="{{ route('admin.departamentos.create') }}" class="btn btn-success">
                                    <i class="voyager-plus"></i> Nuevo Departamento
                                </a>
                            @endcan
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="voyager-trash"></i> ¿Desea eliminar este departamento?</h4>
            </div>
...
<script>
    ...
    function deleteItem(url, nombre) {
        ...
        $('.modal-title').html('<i class="voyager-trash"></i> ¿Eliminar el departamento "<strong>' + nombre + '</strong>"?');
    }

    function list(page = 1) {
        let url = '{{ url("admin/departamentos/ajax/list") }}';
